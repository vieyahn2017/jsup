...
def getScore(name):
    ...
    # 网站升级了，目前是这种 http://www.qimingzi.net/nameReportpc.aspx?surname=%E6%9D%A8&name=%E4%B9%8B%E4%B9%90&sex=%E7%94%B7&year=2023&month=06&date=11&hour=12&minute=17
    # detail_url = "http://www.qimingzi.net/simpleReport.aspx?surname=" + surname + "&name=" + lastname + "&sex=" + s
